...
class Habit(models.Model):
    ...
    is_pleasure = models.BooleanField(verbose_name="Признак приятной привычки", blank=True, null=True, )
    connection_habit = models.ForeignKey('self', on_delete=models.SET_NULL, verbose_name="Связанная приятная привычка", blank=True, null=True, related_name="habits", )
